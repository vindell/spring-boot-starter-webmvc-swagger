...
public class Swagger2WebMvcAutoConfiguration implements BeanFactoryAware {
	 ...
	 * @return
	 */
	private ApiKey apiKey(Swagger2WebMvcProperties swaggerProperties) {
	 ...
	 * @return
	 */
	private BasicAuth basicAuth(Swagger2WebMvcProperties swaggerProperties) {
	 ...
	 * @return
	 */
	private SecurityContext securityContext(Swagger2WebMvcProperties swaggerProperties) {
	 ...
	 * @return
	 */
	private List<SecurityReference> defaultAuth(Swagger2WebMvcProperties swaggerProperties) {
	...
	private List<Parameter> buildGlobalOperationParametersFromSwagger2WebMvcProperties(
	 ...
	 */
	private void buildGlobalResponseMessage(Swagger2WebMvcProperties swaggerProperties, Docket docketForBuilder) {
